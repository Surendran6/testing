  ...
  const onSubmit = async (values) => {
    ...
    try {
      const result = await axios.get(
        `http://localhost:5000/api/private/dashboard-month/${year}/${month}`,
        {
          headers: {
