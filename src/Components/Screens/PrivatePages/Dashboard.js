            ...
            <>
                {
                    ...
                    ?
                    <>
                    <div className="container-fluid authsetting align-1" style={{color : 'rgb(97, 15, 89)'}}>
                    <p className="welcome-msg">Hello <strong className='text-capitalize'> {` ${user}`}</strong>, Welcome Back!</p>
